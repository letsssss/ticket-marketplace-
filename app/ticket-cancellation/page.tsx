...
export default function TicketCancellationPage() {
  ...
  const fetchPopularTickets = async () => {
    try {
      ...
      // Set a fallback or default data when fetch fails
      setPopularTickets([
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="px-2 py-1 bg-green-100 text-green-600 rounded-full text-sm">취켓팅 가능</span>
                  </div>
                </div>
              </div>
            ))}
